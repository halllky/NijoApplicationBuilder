...
import { AggregateOrMember, getEmptyPageState, GridRow, PageState, ValidationError } from './types'
...
export const useBackend = () => {
  ...
  // バリデーション
  const validate = useEvent(async (aggregates: GridRow[]): Promise<ValidationError> => {
