...
export type PageStateFromServer = {
  /** プロジェクトのルートディレクトリ */
...
/** ページ全体の状態（クライアント側での表示のために加工したもの） */
export type PageState = Omit<PageStateFromServer, 'aggregates'> & {
  aggregates: Util.TreeNode<AggregateOrMemberWithId>[]
}

export type AggregateOrMemberWithId = AggregateOrMember & {
  id: string
}
