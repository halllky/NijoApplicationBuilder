...
import { AggregateOrMemberTypeDef, AggregateOrMemberTypeKey, GridRow, OptionalAttributeKey, PageState } from './types'
...
export const useColumnDef = (
  ...
  const {
    typeComboSource,
    typeComboProps,
  } = useTypeCombo(aggregateOrMemberTypes, flattenGridRows)
