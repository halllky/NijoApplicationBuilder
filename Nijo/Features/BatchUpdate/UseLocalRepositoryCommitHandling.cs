    ...
    partial class BatchUpdateFeature {
        ...
        internal static SourceFile UseLocalRepositoryCommitHandling(CodeRenderingContext context) {
            ...
            return new SourceFile {
                FileName = "autogenerated-local-repository-commit.ts",
                RenderContent = () => $$"""
                    /**
                    ...
                    export const useLocalRepositoryCommitHandling = () => {
                      ...
                      const saveHandlerMap = useMemo(() => new Map<string, Util.SaveLocalItemHandler>([
                    {{aggregates.SelectTextTemplate(agg => $$"""
                        ['{{agg.Item.ClassName}}', async (localReposItem: Util.LocalRepositoryStoredItem<AggregateType.{{agg.Item.TypeScriptTypeName}}>) => {
