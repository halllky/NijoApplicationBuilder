...
namespace Nijo {
    ...
    /// dotnet ef のラッパー
    /// </summary>
    public partial class GeneratedProjectMigrator {

        internal GeneratedProjectMigrator(GeneratedProject project, ILogger? log) {
            _project = project;
            _log = log;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public GeneratedProjectMigrator EnsureCreateDatabase() {
        ...
        /// </summary>
        public GeneratedProjectMigrator DeleteAndRecreateDatabase() {
            RemoveAllMigrations();
