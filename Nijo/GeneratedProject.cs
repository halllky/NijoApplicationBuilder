...
namespace Nijo {
    public sealed partial class GeneratedProject {
        ...
        public static GeneratedProject Create(string projectRootDir, string? applicationName, bool keepTempIferror, CancellationToken? cancellationToken = null, ILogger? log = null) {
            ...
            try {
                ...
                tempProject.CodeGenerator.CreateProjectTemplate(applicationName);
