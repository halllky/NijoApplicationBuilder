...
namespace Nijo.Ver1.Models.DataModelModules {
    ...
    internal class EFCoreEntity {
        ...
        internal IEnumerable<EFCoreEntity> EnumerateThisAndDescendants() {
            return new[] { this }.Concat(_aggregate.EnumerateDescendants().Select(e => new EFCoreEntity(e)));
        }


        #region レンダリング
        internal static string RenderClassDeclaring(EFCoreEntity rootEfCoreEntity, CodeRenderingContext ctx) {
            if (rootEfCoreEntity._aggregate is not RootAggregate) throw new InvalidOperationException();
