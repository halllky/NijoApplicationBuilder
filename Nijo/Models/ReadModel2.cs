...
namespace Nijo.Models {
    ...
    internal class ReadModel2 : IModel {
        void IModel.GenerateCode(CodeRenderingContext context, GraphNode<Aggregate> rootAggregate) {
            ...
            customizer.AddMember(multiView.RenderHeaderCustomizeType());
            customizer.AddMember(multiView.RenderSearchConditionCustomizeType());
            customizer.AddMember(multiView.RenderGridCustomizerType());
            ...
            foreach (var agg in allAggregates) {
                ...
                customizer.AddMember(searchDialog.RenderSearchConditionCustomizerType());
                customizer.AddMember(searchDialog.RenderGridCustomizerType());
