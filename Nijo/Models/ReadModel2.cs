...
namespace Nijo.Models {
    ...
    internal class ReadModel2 : IModel {
        void IModel.GenerateCode(CodeRenderingContext context, GraphNode<Aggregate> rootAggregate) {
            ...
            context.UseSummarizedFile<Parts.WebClient.AutoGeneratedCustomizer>().AddMember(multiView.RenderHeaderCustomizeType());

            // UI: SingleView
            var singleView = new SingleView(rootAggregate, SingleView.E_Type.New);
            ...
            // UI: ナビゲーション用関数
            context.ReactProject.UrlUtil.Add(singleView.RenderNavigateFn(context));
