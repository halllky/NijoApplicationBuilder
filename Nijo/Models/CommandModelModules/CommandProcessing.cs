        ...
        internal string RenderAspNetCoreControllerAction(CodeRenderingContext ctx) {
            ...
            return $$"""
                ...
                public async Task<IActionResult> Execute(
                    [ModelBinder(BinderType = typeof(DataModelBinder<>))] {{param.CsClassName}} {{AspNetController.DATA}},
                    [ModelBinder(BinderType = typeof(ContextModelBinder<>))] {{PresentationContext.INTERFACE}}<{{paramMessages.CsClassName}}> {{AspNetController.CONTEXT}}
                ) {
