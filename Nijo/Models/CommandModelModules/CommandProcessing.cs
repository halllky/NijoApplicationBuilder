    ...
    internal class CommandProcessing {
        ...
        internal string RenderAspNetCoreControllerAction(CodeRenderingContext ctx) {
            ...
            return $$"""
                ...
                public async Task<IActionResult> Execute([FromBody] {{param.CsClassName}} {{AspNetController.DATA}}, [FromServices] {{PresentationContext.INTERFACE}}<{{paramMessages.CsClassName}}> {{AspNetController.CONTEXT}}) {
