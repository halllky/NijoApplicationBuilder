    ...
    internal class WriteModel2 : IModel {
        void IModel.GenerateCode(CodeRenderingContext context, GraphNode<Aggregate> rootAggregate) {
            ...
            foreach (var agg in allAggregates) {
                ...
                aggregateFile.DataClassDeclaring.Add(dataClassForNewItem.RenderCSharpMessageStructure(context));
                ...
                aggregateFile.DataClassDeclaring.Add(dataClassForSave.RenderCSharpMessageStructure(context));
