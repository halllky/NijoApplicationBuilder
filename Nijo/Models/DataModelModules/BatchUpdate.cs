    ...
    internal class BatchUpdate {
        ...
        internal string RenderControllerAction(CodeRenderingContext ctx) {
            ...
            return $$"""
                ...
                public async Task<IActionResult> Load(List<{{displayData.CsClassName}}> {{AspNetController.DATA}}, {{PresentationContext.INTERFACE}}<{{MessageContainer.CONCRETE_CLASS_LIST}}<{{displayDataMessages.CsClassName}}>> {{AspNetController.CONTEXT}}) {
