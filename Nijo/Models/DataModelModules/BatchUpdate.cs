    ...
    internal class BatchUpdate {
        ...
        internal string RenderControllerAction(CodeRenderingContext ctx) {
            ...
            return $$"""
                ...
                public async Task<IActionResult> Load([FromBody] List<{{displayData.CsClassName}}> {{AspNetController.DATA}}, [FromServices] {{PresentationContext.INTERFACE}}<{{MessageContainer.CONCRETE_CLASS_LIST}}<{{displayDataMessages.CsClassName}}>> {{AspNetController.CONTEXT}}) {
