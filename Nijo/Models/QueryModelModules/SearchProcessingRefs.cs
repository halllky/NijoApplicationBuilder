    ...
    internal class SearchProcessingRefs {
        ...
        internal string RenderAspNetCoreControllerAction(CodeRenderingContext ctx) {
            ...
            return $$"""
                ...
                public async Task<IActionResult> LoadRefs{{_entryAggregate.PhysicalName}}([FromBody] {{searchCondition.CsClassName}} {{AspNetController.DATA}}, [FromServices] {{PresentationContext.INTERFACE}}<{{searchConditionMessage.CsClassName}}> {{AspNetController.CONTEXT}}) {
                    // エラーチェック
