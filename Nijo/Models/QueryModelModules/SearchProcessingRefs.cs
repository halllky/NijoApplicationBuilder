    ...
    internal class SearchProcessingRefs {
        ...
        internal string RenderAspNetCoreControllerAction(CodeRenderingContext ctx) {
            ...
            return $$"""
                ...
                public async Task<IActionResult> LoadRefs{{_entryAggregate.PhysicalName}}({{searchCondition.CsClassName}} {{AspNetController.DATA}}, {{PresentationContext.INTERFACE}}<{{searchConditionMessage.CsClassName}}> {{AspNetController.CONTEXT}}) {
                    // エラーチェック
