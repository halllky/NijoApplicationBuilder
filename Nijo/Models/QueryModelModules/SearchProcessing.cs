    ...
    internal class SearchProcessing {
        ...
        internal string RenderAspNetCoreControllerAction(CodeRenderingContext ctx) {
            ...
            return $$"""
                ...
                public async Task<IActionResult> Load([FromBody] {{searchCondition.CsClassName}} {{AspNetController.DATA}}, [FromServices] {{PresentationContext.INTERFACE}}<{{searchConditionMessages.CsClassName}}> {{AspNetController.CONTEXT}}) {
                    // エラーチェック
