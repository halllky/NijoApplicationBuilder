...
namespace Nijo.Models.ReadModel2Features {
    ...
    internal class SingleViewAggregateComponent {
        ...
        internal virtual string RenderDeclaring(CodeRenderingContext context) {
            ...
            return $$"""
                const {{ComponentName}} = () => {
                  const { reactHookFormMethods, mode } = useContext({{SingleView.PAGE_CONTEXT}})
                  const { register, registerEx, getValues, setValue, formState: { errors }, control } = reactHookFormMethods
                {{If(existsCustomUi, () => $$"""
            ...
            internal override string RenderDeclaring(CodeRenderingContext context) {
                ...
                return $$"""
                    ...
                    """)}}
                      ...
                      const { reactHookFormMethods, mode } = useContext({{SingleView.PAGE_CONTEXT}})
                      const { register, registerEx, getValues, setValue, formState: { errors } } = reactHookFormMethods
                    {{If(existsCustomUi, () => $$"""
                      const { {{AutoGeneratedCustomizer.CUSTOM_UI_COMPONENT}} } = {{AutoGeneratedCustomizer.USE_CONTEXT}}()
                    """)}}
            ...
            internal override string RenderDeclaring(CodeRenderingContext context) {
                ...
                return $$"""
                    ...
                    """)}}
                      ...
                      const { reactHookFormMethods, mode } = useContext({{SingleView.PAGE_CONTEXT}})
                      const { register, registerEx, getValues, formState: { errors }, control } = reactHookFormMethods
