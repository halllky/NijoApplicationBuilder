...
namespace Nijo.Models.ReadModel2Features {
    ...
    internal class MultiViewEditable : IReactPage {
        ...
        internal string DataHookName => $"use{_rootAggregate.Item.PhysicalName}MultiViewEditData";
        ...
        public SourceFile GetSourceFile() => new() {
            ...
            RenderContent = ctx => {
                ...
                var rootAggregateComponent = new SingleViewAggregateComponent(_rootAggregate);
