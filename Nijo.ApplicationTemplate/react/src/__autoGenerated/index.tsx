...
import { UiContextProvider } from './default-ui-component'
...
const ApplicationRootOutOfContext = (props: DefaultNijoAppProps) => {
              ...
              <UiContextProvider customizer={props.uiCustomizer}>
                <DialogContextProvider>
                  {LoginPage ? (
                    ...
                    <LoginPage LoggedInContents={<ApplicationRootInContext {...props} />} />
                  ) : (
...
export function DefaultNijoApp(props: DefaultNijoAppProps) {
  ...
  const router = useMemo(() => {
    console.log('#60:依存配列にObject.valuesを使って問題ないかの確認。確認終わったらこのログを消すこと')
    ...
    return createBrowserRouter([{
      path: '/',
      element: <ApplicationRootOutOfContext {...props} />,
