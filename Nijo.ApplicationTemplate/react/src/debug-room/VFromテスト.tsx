 ...
 * - depth: 0, 1以上
 * - label: あり、なし
 * - estimatedLabelWidth: 指定あり、なし
 * - estimatedValueWidth: 指定あり、なし
...
export default function () {
  ...
  return (
    <div className={`flex flex-col ${dark && 'dark'}`} style={{ fontFamily: 'BIZ UDGothic' }}>
      ...
      <VForm.Container label="メイン" estimatedLabelWidth="10rem" className={rootClassName}>
      ...
      <VForm.Container label="Containerのみ" estimatedLabelWidth="14rem" className={rootClassName}>
