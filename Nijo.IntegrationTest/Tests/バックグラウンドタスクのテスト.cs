    ...
    partial class 観点 {
        ...
        public async Task 最小限のバックグラウンドタスクをWebから起動して正常終了するまでを確認() {
            ...
            TestProject.UpdateAutoGeneratedCode(
                new DataPatternsClass._017_CommandModel());
                //DataPattern.FromFileName(DataPattern.FILENAME_017));
            ...
            // ジョブ起動
            var uploadFile = Path.Combine(Directory.GetCurrentDirectory(), "test017.csv");
