...
namespace HalApplicationBuilder.EntityFramework {
    public class AutoGeneratedMethods {
        ...
        public class Search {
            public Search(DbEntity dbEntity, Config config) {
                _dbEntity = dbEntity;
                _config = config;
            }
            ...
            public string SearchResultClassName => $"{_config.MvcModelNamespace}.{_dbEntity.ClassName}";
            public string SearchConditionClassName => null; // TODO
            public string DbSetName => _dbEntity.DbSetName;
            public string MethodName => $"Search_{_dbEntity.ClassName}";
        }
