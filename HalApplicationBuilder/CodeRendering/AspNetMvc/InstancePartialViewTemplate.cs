...
namespace HalApplicationBuilder.CodeRendering.AspNetMvc {
    ...
    public partial class InstancePartialViewTemplate : InstancePartialViewTemplateBase {
        ...
        public virtual string TransformText() {
            ...
            this.Write(";\n\n<div class=\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(JsTemplate.AGG_PARTIAL_CONTAINER));
            this.Write("\">\n    @if (");
            this.Write(this.ToStringHelper.ToStringWithCulture(_showRemoveButton));
 ...
 PushIndent("    "); 
 _aggregate.RenderAspNetMvcPartialView(new RenderingContext(this, new ObjectPath("Model"))); 
 PopIndent(); 
            this.Write("\n");
