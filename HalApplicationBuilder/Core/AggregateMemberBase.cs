...
namespace HalApplicationBuilder.Core {
    public abstract class AggregateMemberBase {
        ...
        internal abstract IEnumerable<AutoGenerateMvcModelProperty> ToSearchConditionModel();
        internal abstract IEnumerable<AutoGenerateMvcModelProperty> ToSearchResultModel();
        internal abstract IEnumerable<AutoGenerateMvcModelProperty> ToInstanceModel();
