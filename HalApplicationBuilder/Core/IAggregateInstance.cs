...
namespace HalApplicationBuilder.Core {
    internal interface IAggregateInstance : IGraphNode {
        ...
        internal class Property {
            internal required GraphNode<IAggregateInstance> Owner { get; init; }
        ...
        internal class ChildrenProperty : Property {
            internal required GraphNode<IAggregateInstance> ChildAggregateInstance { get; init; }
        ...
        internal class VariationSwitchProperty : Property {
            internal required VariationGroup<IAggregateInstance> Group { get; init; }
        ...
        internal class RefProperty : Property {
            internal required GraphNode<IAggregateInstance> RefTarget { get; init; }
            internal required NavigationProperty CorrespondingNavigationProperty { get; init; }
