...
namespace HalApplicationBuilder {
    public sealed partial class HalappProject {
        ...
        public HalappProject UpdateAutoGeneratedCode() {
            ...
            if (!Directory.Exists(WebClientProjectRoot)) {
                DotnetEx.IO.CopyDirectory(reactProjectTemplate, WebClientProjectRoot);
            }

            DirectorySetupper.Directory(Path.Combine(WebClientProjectRoot, "src", "__autoGenerated"), _log, reactDir => {
