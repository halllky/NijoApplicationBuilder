    ...
    public class Program {
        ...
        static async Task<int> Main(string[] args) {
            ...
            create.SetHandler((applicationName, keepTempIferror) => {
                ...
                HalappProject.Create(projectRootDir, applicationName, keepTempIferror, cancellationTokenSource.Token, logger);
            ...
            debug.SetHandler(async (path) => {
                ...
                var project = HalappProject.Open(path, logger);
