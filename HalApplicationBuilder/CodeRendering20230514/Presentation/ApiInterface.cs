...
namespace HalApplicationBuilder.CodeRendering20230514.Presentation
{
 ...
 foreach (var prop in searchResult.GetMembers()) { 
            ...
            this.Write("\r\n");
 /* シングルビューDTO */ 
 foreach (var aggregateInstance in _ctx.Schema.ToAggregateInstanceGraph()) { 
            this.Write("    public class ");
            ...
            this.Write(" {\r\n");
 foreach (var prop in aggregateInstance.GetProperties(_ctx.Config)) { 
            this.Write("        public ");
