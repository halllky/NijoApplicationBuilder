...
namespace HalApplicationBuilder.CodeRendering20230514.ReactAndWebApi {
    partial class ReactComponent {
        ...
        internal string MultiViewComponentName => $"MultiView{_agg.Item.DisplayName.ToCSharpSafe()}";
        internal string CreateViewComponentName => $"CreateView{_agg.Item.DisplayName.ToCSharpSafe()}";
        internal string SingleViewComponentName => $"SingleView{_agg.Item.DisplayName.ToCSharpSafe()}";

        internal string UseQueryKey => _agg.Item.UniqueId;

        internal string SubDomain => _agg.Item.DisplayName.ToCSharpSafe();
