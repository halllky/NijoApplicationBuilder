...
import { ForeignKeyReferenceDialog, useDbRecordGridColumnDef } from "./useDbRecordGridColumnDef"
 ...
 * DBレコード一括編集ウィンドウ
 */
export const DbTableMultiEditorView = React.forwardRef(({ itemIndex, value, onChangeDefinition, onDeleteDefinition, tableMetadataHelper, trigger, zoom, handleMouseDown }: {
  itemIndex: number
