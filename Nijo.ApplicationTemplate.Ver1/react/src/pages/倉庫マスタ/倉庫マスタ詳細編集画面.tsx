                ...
                <ReactHookForm.FormProvider {...methods}>
                    <Layout.VForm3.Root>
                        <Layout.VForm3.BreakPoint>
                            <Layout.VForm3.Item label="倉庫ID" required={AutoGenerated.倉庫マスタConstraints.values.倉庫ID.required}>
                                <Input.Word name="values.倉庫ID" control={control} readOnly={!isNew}
                                    rules={{
                                        required: "倉庫IDは必須です。",
                                        maxLength: { value: AutoGenerated.倉庫マスタConstraints.values.倉庫ID.maxLength!, message: `倉庫IDは${AutoGenerated.倉庫マスタConstraints.values.倉庫ID.maxLength}文字以内` }
                                    }} />
                            </Layout.VForm3.Item>
