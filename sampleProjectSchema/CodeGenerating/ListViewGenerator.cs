...
namespace haldoc.CodeGenerating {
    ...
    public partial class ListViewGenerator : ListViewGeneratorBase {
        ...
        public virtual string TransformText() {
            ...
            this.Write("\n@model haldoc.Runtime.ListViewModel<\n    haldoc.AutoGenerated.Mvc.");
            this.Write(this.ToStringHelper.ToStringWithCulture(Aggregate.ToSearchConditionModel().ClassName));
            this.Write(",\n    haldoc.AutoGenerated.Mvc.");
            this.Write(this.ToStringHelper.ToStringWithCulture(Aggregate.ToListItemModel().ClassName));
            this.Write(">;\n@{\n    ViewData[\"Title\"] = \"");
            ...
            this.Write("\n</h1>\n\n<form>\n    \n    @* 検索条件欄 *@\n    <div class=\"container\">\n        <div clas" +
                    "s=\"form-horizontal\">\n");
 foreach (var prop in Aggregate.ToSearchConditionLayout(nameof(haldoc.Runtime.ListViewModel<object, object>.Filter))) { 
            ...
            this.Write("\n                </label>\n                <div class=\"col-sm-10\">\n");
 foreach (var layout in prop.Layout) { 
            this.Write("                    ");
