...
import { PreviewFrame, usePreviewFrame, usePreviewState } from "./Preview"
...
export default function App() {
  ...
  // デバッグ実行プロセスの状態・ログとその操作。対象アプリが応答し始めたらiframeを読み込み直す
  const preview = usePreviewState({ onTargetReachable: frame.reload })
